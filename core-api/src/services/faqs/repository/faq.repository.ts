...
export class FaqRepository extends DddRepository<Faq> {
  ...
  async find(
    conditions: { id?: number; type?: FaqType; status?: FaqStatus; question?: string; answer?: string },
  ...
  async count(conditions: { id?: number; type?: FaqType; status?: FaqStatus; question?: string; answer?: string }) {
